...
<div class="wrapper">
				<div class="col-md-12 col-lg-12">
					<a data-toggle="modal" href="#myModal" class="btn btn-primary pull-right">Tambah Materi</a>
				</div>
					...
					<div class="panel-body">
						<div class="row">							
							...
							<div class="col-md-6 col-lg-6">
								<div class="panel panel-dark panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">3. Integral
										<button type="button" class="btn btn-danger pull-right" style="margin: 10px 5px 0 0 !important;">Hapus</button>
										<button type="button" class="btn btn-success pull-right" style="margin: 10px 5px 0 0 !important;">Download</button>
										</h3>
									</div>
							...
							<div class="col-md-6 col-lg-6">
								<div class="panel panel-dark panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">4. Integral
										<button type="button" class="btn btn-danger pull-right" style="margin: 10px 5px 0 0 !important;">Hapus</button>
										<button type="button" class="btn btn-success pull-right" style="margin: 10px 5px 0 0 !important;">Download</button>
										</h3>
									</div>
							...
							<div class="col-md-6 col-lg-6">
								<div class="panel panel-dark panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">5. Integral
										<button type="button" class="btn btn-danger pull-right" style="margin: 10px 5px 0 0 !important;">Hapus</button>
										<button type="button" class="btn btn-success pull-right" style="margin: 10px 5px 0 0 !important;">Download</button>
										</h3>
									</div>
							...
							<div class="col-md-6 col-lg-6">
								<div class="panel panel-dark panel-primary">
									<div class="panel-heading">
										<h3 class="panel-title">6. Integral
										<button type="button" class="btn btn-danger pull-right" style="margin: 10px 5px 0 0 !important;">Hapus</button>
										<button type="button" class="btn btn-success pull-right" style="margin: 10px 5px 0 0 !important;">Download</button>
										</h3>
									</div>
